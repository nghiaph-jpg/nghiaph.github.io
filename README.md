// ==UserScript==
// @name         Changeable Radar + CoolName
// @namespace    
// @version      
// @description   idk
// @author       Yay
...
var Healthbarcolor = "#00bfff"
var Healthbarcolor2 = "#ff0000"
...
<div id="simpleModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 style="font-size: 17px;">A RadaR XD</h2>
        </div>
...
<fieldset>
        ...
        <div class="modal-footer">
            <h3 style="font-size: 17px;">By Wealthy#0069</h3>
        </div>
    </div>
</div>
`
...
var newImg = document.createElement("img");
    newImg.src = "https://i.pinimg.com/736x/66/bf/42/66bf42d06ae2499c7c9ca45eb2abd851.jpg"
...
menu.innerHTML = `
    <div class="i-tab-container">
      <div class="i-tab-menu sidebar">
        <a href="https://youtube.com/WealthyMod/"><h2 class="i-tab-menu-item">WealthyMod</h2></a>
      ...
      <div id="mm-main-menu" class="i-tab-content">
        ...
        <label>Auto Chat: <input id="mm-autoChatMessage" type="text" minlength="0" maxlength="30" style="width: 250px;" placeholder="Auto Text" class="i-checkbox"></label>
        <fieldset>
        ...
        <div class="i-palomita">Made - by <a href="http://youtube.com/">Wealhy</a></div>
      </div>
      <div id="mm-offense-menu" class="i-tab-content" style="display: none;">
        ...
        <div class="i-palomita">Made - by <a href="https://youtube.com/">Wealthy</a></div>
      </div>
      ...
      <div id="mm-controls-menu" class="i-tab-content" style="display: none;">
        <h3>Controls</h3>
        <label>Menu: <button id="mm-keybind-openMenu" class="i-button i-bold i-right i-inline i-keybind">ESCAPE</button></label>
        <br>
        ...
        for (var t = 1, n = 0; n < e.length; n += 3) ! function (n) {
            s.generateElement({
                ...
                children: [s.generateElement({
                    ...
                    style: "color:" + (e[n] == j ? "#000000" : "rgba(255,255,255,0.6)"),
    ...
    function Ci(e) {
        if (!(e < 0)) {
            var t = Math.floor(e / 60),
                n = e % 60;
            n = ("0" + n).slice(-2), Ee.innerText = "Server will be crashed in " + t + ":" + n, Ee.hidden = !1
        }
    }
        ...
        function e() {
            B = Date.now(), P = B - q, q = B,
                function () {
                    ...
                    for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(0, 0, oe, ce), be.strokeStyle = rt, a = 0; a < W.length + Y.length; ++a)
                       if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ ==
								R || _.team && _.team == R.team)) {//ã€–ã€—
						var w = (_.team ? "â• ~" + _.team + "~â•£" : "") + (_.isPlayer&&_.sid? "â™›" : "") + (_.name + "â™›"|| "");
							if ("" != w) {
                            ...
                            window.w = R.weapons;
                            var HP1234 = ("â™¥HPâ™¥: " + _.dmgOverTime + "/" + _.maxHealth);
                            var cord1234 = ("â¤¾â¤¿ : " + Math.round(_.x) + "  |  â¤ºâ¤» : " + Math.round(_.y));
                ...
                var color = '#' + r1213.toString(16) + g1213.toString(16) + b1213.toString(16);
                    ...
                    function (e) {
                        if (R && R.alive) {
                            Ke.clearRect(0, 0, Ne.width, Ne.height), Ke.strokeStyle = "#663399", Ke.lineWidth = 4;
                            for (var t = 0; t < qt.length; ++t)(Vt = qt[t]).update(Ke, e);
                            if (Ke.globalAlpha = 1, Ke.fillStyle = "#663399", si(R.x / o.mapScale * Ne.width, R.y / o.mapScale * Ne.height, 7, Ke, !0), Ke.fillStyle = "rgba(255,255,255,0.35)", R.team && Et)
                                for (t = 0; t < Et.length;) si(Et[t] / o.mapScale * Ne.width, Et[t + 1] / o.mapScale * Ne.height, 7, Ke, !0), t += 2;
                            It && (Ke.fillStyle = "#663399", Ke.font = "34px Hammersmith One", Ke.textBaseline = "middle", Ke.textAlign = "center", Ke.fillText("x", It.x / o.mapScale * Ne.width, It.y / o.mapScale * Ne.height)), Mt && (Ke.fillStyle = "#663399", Ke.font = "34px Hammersmith One", Ke.textBaseline = "middle", Ke.textAlign = "center", Ke.fillText("x", Mt.x / o.mapScale * Ne.width, Mt.y / o.mapScale * Ne.height))
                        }
